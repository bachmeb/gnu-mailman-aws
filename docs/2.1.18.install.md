...
postconf alias_maps
postconf -e "alias_maps = hash:/etc/aliases, hash:/etc/postfix/aliases, hash:/usr/local/mailman/data/aliases"
```
...
##### Make changes to the configuration of the mailman site list by first editing the sitelist.cfg file
...
http://[somehost].[whatever]/mailman
